...
<body id="page-top">
    ...
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Registrar Nuevo Producto</h1>
        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="p-5">
                            ...
                            <form class="user" action="CrearProductoController" method="POST">
                                ...
                                <div class="form-group row d-flex justify-content-center">
                                    <div class="col-sm-6 mb-3">
                                        ...
                                        <input type="number" id="restauranteId" class="form-control" name="restauranteId" required><br>
                                    </div>
                                </div>
